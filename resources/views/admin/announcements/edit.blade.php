...
<div class="admin-container">
    ...
    <div class="admin-main">
        ...
        <div class="admin-content">
            ...
            <!-- Form Card -->
            <div class="form-card">
                <form method="POST" action="{{ route('admin.announcements.update', $announcement) }}" id="announcementForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea id="message" name="message" class="form-control" rows="6" 
                                      required maxlength="2000">{{ old('message', $announcement->message) }}</textarea>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="form-help">Uncheck to deactivate the announcement</div>
                        </div>
                    </div>
                    ...
                    <div class="preview-section">
                        ...
                        <div id="announcementPreview" class="announcement-preview">
                            <div class="alert {{ $announcement->getAlertClass() }}">
